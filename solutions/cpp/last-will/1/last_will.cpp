...
namespace estate_executor {
    int assemble_account_number(int secret_modifier) {
        int sum_of_bank_number_part = zhang::bank_number_part(secret_modifier) + khan::bank_number_part(secret_modifier) + garcia::bank_number_part(secret_modifier);
        return sum_of_bank_number_part;
    }

    int assemble_code() {
        int sum_of_blue = zhang::blue::code_fragment() + khan::blue::code_fragment() + garcia::blue::code_fragment();
        int sum_of_red = zhang::red::code_fragment() + khan::red::code_fragment() + garcia::red::code_fragment();
        int a_code = sum_of_blue * sum_of_red;
        return a_code;
    }
}

...
def get_value_of_bills(denomination, number_of_bills):
    ...
    """
    v_bill = denomination * number_of_bills
    return v_bill
...
def get_number_of_bills(amount, denomination):
    ...
    """
    n_bill = int(amount / denomination)
    return n_bill
...
def get_leftover_of_bills(amount, denomination):
    ...
    """
    temp = int(amount / denomination)
    leftover = amount - temp * denomination
    return leftover
...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    """
    p_spread = 0.01 * spread
    f_exchange_rate = (p_spread * exchange_rate) + exchange_rate
    temp = budget / f_exchange_rate
    number = int(temp / denomination)
    e_value = number * denomination
    return e_value
